...
> <span style='background-color:#f1f8ff'>모든 왼쪽 자식들 <= 현재 노드 < 모든 오른쪽 자식들</span>
> 
...
> 하지만 위의 그림은 이진 탐색 트리가 아니다. <span style='background-color:#f1f8ff'>15가 8의 왼쪽에 있기 때문이다.</span> <br>
